...
const Icons = {
  ...
  bookOpen: BookOpen,
  calculator: Calculator, // Added
  check: Check,
  chevronDown: ChevronDown,
  chevronLeft: ChevronLeft,
  chevronRight: ChevronRight,
  chevronUp: ChevronUp,
  chevronsUpDown: ChevronsUpDown, // Added
  circle: Circle,
  workflow: Workflow,
  close: X,
  copy: Copy,
